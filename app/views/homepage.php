    ...
    <main>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-center">
                        ...
                        <div class="dropdown text-end mb-2 mb-md-0 mx-auto mx-sm-0">
                            <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle"
                                ...
                                <img src="/public/assets/images/User.jpg" alt="member" width="32" height="32"
                            ...
                            <ul class="dropdown-menu text-small">
                                ...
                                <li><a href="/" class="logout-btn dropdown-item">Sign out</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <!-- <div class="container-xl text-center">
            ...
            <p class="lead">Welcome,
                <?php echo htmlspecialchars($_SESSION['username']); ?>! This will be your dashboard.
            </p>
        </div> -->
